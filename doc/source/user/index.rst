...
_`cinder_csi_enabled`
  If set to true, out-of-tree Cinder CSI driver will be enabled. Requires
  'cinder' to be selected as a 'volume_driver' and consequently also requires label
...
_`cinder_csi_plugin_tag`
  ...
  For additional tags, `refer to this page
...
_`csi_node_driver_registrar_tag`
  ...
  driver registrar. For additional tags, `refer to this page
