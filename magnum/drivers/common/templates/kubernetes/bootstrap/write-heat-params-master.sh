...
MANILA_CSI_CHART_TAG="$MANILA_CSI_CHART_TAG"
NFS_CSI_CHART_TAG="$NFS_CSI_CHART_TAG"
...
CINDER_CSI_CHART_TAG="$CINDER_CSI_CHART_TAG"
...
AUTOSCALER_CHART_TAG="$AUTOSCALER_CHART_TAG"
MIN_NODE_COUNT="$MIN_NODE_COUNT"
MAX_NODE_COUNT="$MAX_NODE_COUNT"
NPD_ENABLED="$NPD_ENABLED"
NPD_CHART_TAG="$NPD_CHART_TAG"
