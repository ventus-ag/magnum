...
RECONCILER_VERSION_INPUT='$RECONCILER_VERSION'
RECONCILER_BINARY_URL_INPUT='$RECONCILER_BINARY_URL'
RECONCILER_BINARY_URL_SHA256_INPUT='$RECONCILER_BINARY_URL_SHA256'
RECONCILER_RUN_INTERVAL_INPUT='$RECONCILER_RUN_INTERVAL'
RECONCILER_LOCK_TIMEOUT_SECONDS_INPUT='$RECONCILER_LOCK_TIMEOUT_SECONDS'
RECONCILER_VERSION="${RECONCILER_VERSION_INPUT:-${RECONCILER_DEFAULT_VERSION}}"
RECONCILER_BINARY_URL="${RECONCILER_BINARY_URL_INPUT:-${RECONCILER_DEFAULT_BINARY_URL}}"
RECONCILER_BINARY_URL_SHA256="${RECONCILER_BINARY_URL_SHA256_INPUT:-}"
RECONCILER_RUN_INTERVAL="${RECONCILER_RUN_INTERVAL_INPUT:-120min}"
RECONCILER_LOCK_TIMEOUT_SECONDS="${RECONCILER_LOCK_TIMEOUT_SECONDS_INPUT:-900}"
...
MANILA_CSI_PLUGIN_ENABLED="$MANILA_CSI_PLUGIN_ENABLED"
CINDER_CSI_PLUGIN_ENABLED="$CINDER_CSI_PLUGIN_ENABLED"
...
RECONCILER_RUN_INTERVAL="${RECONCILER_RUN_INTERVAL}"
