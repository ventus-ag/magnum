...
COREOS_SELINUX_DISABLE="$COREOS_SELINUX_DISABLE"
ISTIO_ENABLED="$ISTIO_ENABLED"
ISTIO_TAG="$ISTIO_TAG"
CINDER_ENABLED="$CINDER_ENABLED"
TEKTON_ENABLED="$TEKTON_ENABLED"
TEKTON_TAG="$TEKTON_TAG"
KNATIVE_ENABLED="$KNATIVE_ENABLED"
KNATIVE_TAG="$KNATIVE_TAG"
KFSERVING_ENABLED="$KFSERVING_ENABLED"
KFSERVING_TAG="$KFSERVING_TAG"
